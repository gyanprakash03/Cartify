      ...
      <nav className="flex justify-between items-center h-20 max-w-6xl mx-auto px-4">
        ...
        <NavLink to="/">
          ...
          <div className="flex items-center font-medium text-slate-100 mr-5 space-x-10">
            <NavLink to="/">
              <p className="hover:text-blue-300 duration-300">Home</p>
            </NavLink>

            <NavLink to="/cart">
              <div className="relative hover:text-blue-300 duration-300">
                  <FaShoppingCart className="text-2xl"/>
                  {
                    cart.length > 0 &&
                    <span
                    className="absolute -top-1 -right-2 bg-blue-700 text-xs w-5 h-5 flex 
